...
1. Using the mailing list contact form code provided by your vendor, add the form action URL and the form field ID for the e-mail field into the widget options.
1. Verify it works!
